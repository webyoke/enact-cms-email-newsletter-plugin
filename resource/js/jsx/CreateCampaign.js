    ...
    render: function(){
        ...
        if(this.state.data.template && this.state.variables.length){
            this.state.variables.map(function(variable,i){
                ...
                if(variable.type == 'textarea'){
                    input = React.createElement("textarea", {name: variable.handle, onChange: that.onChangeVariable, value: that.state.data.variables[variable.handle]});
                } else {
                    input = React.createElement("input", {type: variable.type, name: variable.handle, onChange: that.onChangeVariable, value: that.state.data.variables[variable.handle]})
                }//el
        ...
        return (
                React.createElement("div", null, 
                    React.createElement("div", {className: "row heading-con"}, 
                    ...
                    React.createElement("div", {className: "content-con"}, 
